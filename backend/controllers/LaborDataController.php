...
class LaborDataController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if (!$isAdmin) {
            ...
            if ($record && $record->labor_data_id) {
                ...
                return $this->redirect(['view', 'id' => $record->labor_data_id]);
            }
        }
        ...
        if ($this->request->isPost) {
            ...
            if ($model->save()) {
                // Guardar la única academia seleccionada
                if ($academyId) {
                ...
                if (!$isAdmin) {
                    ...
                    Yii::$app->session->setFlash('success', 'Datos laborales guardados. Tu expediente ha sido creado.');
    ...
    public function actionUpdate($id)
    {
        ...
        // Academia actual (solo la primera, ya que ahora es una sola)
