...
$canFinalize = $checklist ? $checklist['isComplete'] : false;
?>
...
<div class="record-view">
        ...
        <?php if ($isAdmin): ?>
            ...
            <div class="ms-auto d-flex gap-2">
                ...
                <?php if ($model->isInactivo()): ?>
                    <?= Html::a('↩ Regresar a Incompleto', ['update-status', 'id' => $model->id, 'status' => 'Registro'], [
                        'class' => 'btn btn-sm btn-outline-warning',
                        'data'  => ['method' => 'post', 'confirm' => '¿Regresar a Incompleto para que el docente pueda editarlo?'],
                    ]) ?>
                <?php endif; ?>
    ...
    <?php if (!$isAdmin && !$isConsultor && $checklist && !$model->isActivo()): ?>
        <?= $this->render('_completion_checklist', [
            'checklist' => $checklist,
            'showActions' => $model->isRegistro(),
        ]) ?>
    <?php endif; ?>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <?php if ($teaching): ?>
                ...
                <?php if (!$isConsultor && ($isAdmin || !$model->isInactivo())): ?>
            ...
            <?php else: ?>
                ...
                <?php if (!$isConsultor): ?>
                    <?= Html::a('+ Registrar datos personales', ['/teaching/create'], ['class' => 'btn btn-sm btn-primary']) ?>
                <?php endif; ?>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-header bg-warning text-dark d-flex justify-content-between align-items-center">
            ...
            <?php if (!$isConsultor && ($isAdmin || !$model->isInactivo()) && count($emergencyContacts) < 2): ?>
                    ...
                    <tbody>
                        <?php foreach ($emergencyContacts as $contact): ?>
                            <tr>
                                ...
                                <?php if (!$isConsultor && ($isAdmin || !$model->isInactivo())): ?>
                                    <td>
                                        <?= Html::a('✏️', ['/emergency-contact/update', 'id' => $contact->id], ['class' => 'btn btn-sm btn-outline-primary']) ?>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <?php else: ?>
                ...
                <?php if (!$isConsultor): ?>
                    <?= Html::a('+ Registrar datos laborales', ['/labor-data/create'], ['class' => 'btn btn-sm btn-success']) ?>
                <?php endif; ?>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="card border-success mb-4">
        <div class="card-body d-flex align-items-center justify-content-between">
            ...
            <?= Html::a('✅ Finalizar expediente', ['update-status', 'id' => $model->id, 'status' => 'Activo'], [
                'class' => 'btn btn-success btn-lg ms-3' . ($canFinalize ? '' : ' disabled'),
